...
function formatProviderLabel(provider?: string) {
  if (provider === 'agentic') return 'Google Cloud (Vertex AI)';
  if (provider === 'v0') return 'v0 Live Site';
  if (provider === 'hybrid') return 'Hybrid Google + v0';
        ...
        <Header
          ...
          subtitle={
            activeTab === 'dashboard'
              ...
              : activeTab === 'demos'
              ? 'Interactive demos generated by Google Cloud (Vertex AI), v0, or Hybrid engines.'
              : activeTab === 'pipeline'
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
              ...
              <MetricCard
                ...
                badge={formatProviderLabel(settings.demoProvider)}
                icon={Wand2}
              />
              <MetricCard
                label="Outreach Sent"
              ...
              <div>
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-[10px] font-bold px-2.5 py-0.5 rounded-full bg-blue-50 text-blue-700 border border-blue-100">
                    {formatProviderLabel(settings.demoProvider)} engine
                  </span>
                </div>
                <p className="text-xs text-gray-500 font-medium mt-0.5">
                  Build and preview demos with Google Cloud Vertex AI, v0, or Hybrid generation
                </p>
              </div>
                    ...
                    >
                      ...
                      <div className="mt-2 text-[11px] font-semibold text-blue-600 flex items-center justify-between">
                        <span className="flex items-center gap-1 text-gray-600">
                          ...
                          <span>{formatProviderLabel(lead.demo_provider || settings.demoProvider)} demo</span>
                        </span>
                        {isReady && (
                ...
                {selectedDemoLead ? (
                  <div className="border border-slate-800 rounded-3xl bg-slate-950 text-white flex flex-col flex-1 overflow-hidden shadow-2xl">
                    ...
                    <div className="px-4 py-2.5 bg-slate-900 border-t border-slate-800 flex items-center justify-between text-[11px] text-slate-400">
                      <span>Engine: {formatProviderLabel(selectedDemoLead.demo_provider || settings.demoProvider)}</span>
