        ...
        <Header
          ...
          subtitle={
            activeTab === 'dashboard'
              ...
              : activeTab === 'demos'
              ? 'Interactive live prototypes generated by Vercel v0.'
              : activeTab === 'pipeline'
        ...
        {activeTab === 'demos' && (
          <div className="panel p-6 space-y-6">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-gray-100 pb-4">
              <div>
                <div className="flex items-center gap-2">
                  <h3 className="text-lg font-extrabold text-gray-900">v0 AI Demo Lab</h3>
                  <span className="text-[10px] font-bold px-2.5 py-0.5 rounded-full bg-emerald-50 text-emerald-700 border border-emerald-200">
                    v0 Live Site Builder
                  </span>
                </div>
                <p className="text-xs text-gray-500 font-medium mt-0.5">
                  Build and deploy live, high-converting interactive web applications with Vercel v0
                </p>
              </div>
