              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2.5">
                  ...
                  <div>
                    ...
                    <div className="text-[10px] text-gray-500">Automatically build live v0 demo sites for all qualified leads</div>
                  </div>
                </div>
                <input
                  type="checkbox"
                  checked={form.autoGenerateDemos !== false}
                  onChange={(e) => setForm({ ...form, autoGenerateDemos: e.target.checked, demoQuality: 'low' })}
