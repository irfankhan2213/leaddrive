      ...
      <div className="panel bg-white max-w-xl w-full p-5 shadow-2xl relative animate-in fade-in zoom-in-95 duration-200 max-h-[90vh] flex flex-col overflow-hidden">
        ...
        <form onSubmit={handleSubmit} className="flex-1 flex flex-col min-h-0">
          <div className="flex-1 overflow-y-auto pr-1 space-y-3.5 pb-2 scrollbar-thin">
            ...
            <div className="p-3 rounded-xl bg-purple-50/70 border border-purple-200/80 space-y-2.5">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  <Sparkles className="w-4 h-4 text-purple-600" />
                  <div>
                    <div className="text-xs font-extrabold text-purple-950">Auto-Generate v0 AI Demos</div>
                    <div className="text-[10px] text-purple-700">Automatically build live v0 demo sites for all qualified leads</div>
                  </div>
                </div>
                <input
                  type="checkbox"
              ...
              {form.autoGenerateDemos !== false && (
                <div className="pt-2 border-t border-purple-200/60">
                  <div className="text-[10px] font-extrabold uppercase tracking-wider text-purple-800 mb-1.5 flex items-center justify-between">
                    <span>Demo Quality & Generation Mode</span>
                    <span className="font-bold lowercase">
                      {form.demoQuality === 'high' ? '👑 flagship (v0-pro)' : '⚡ fast (v0-mini)'}
                    </span>
                  </div>
                  <div className="grid grid-cols-2 gap-2">
                    <button
                      ...
                      className={`p-2 rounded-xl border text-left transition-all ${
                        form.demoQuality !== 'high'
                          ...
                          : 'bg-white/60 border-purple-200/70 hover:bg-white text-gray-600'
                      }`}
                    >
                      <div className="flex items-center gap-1.5 font-extrabold text-xs text-gray-900">
                    ...
                    <button
                      ...
                      className={`p-2 rounded-xl border text-left transition-all ${
                        form.demoQuality === 'high'
                          ? 'bg-white border-purple-600 ring-2 ring-purple-500/30 shadow-xs'
                          : 'bg-white/60 border-purple-200/70 hover:bg-white text-gray-600'
                      }`}
                    >
                      ...
                      <div className="text-[10px] text-purple-700 mt-0.5">
                        Luxury glassmorphism, interactive quote calculator & booking drawer (v0-pro)
                      </div>
                    </button>
                  </div>
                </div>
